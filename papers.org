...
$\theta_k \sim p(\theta \mid D_n)\qquad k = 1,\ldots,K$

** 記述が全然追えてないので渡辺本を読む必要がありそう
...
確率変数　$x_i\in\mathbf{R^d}$ は，独立に真の分布$q(x)$ に従い，これに関して我々は何も知らない．これを未知の分布という．
ここからn個のデータを集めたとき，それをサンプルと呼ぶ．ここでn個のサンプルから未知である$q(x)$を推測するという問題を考える．
...
* INBOX You’re Measuring Model Complexity Wrong
...
* INBOX  https://arxiv.org/pdf/2402.05162
* INBOX What should be learned first
* INBOX UNVEILING THE BASIN-LIKE LOSS LANDSCAPE IN LARGE LANGUAGE MODELS
...
* INBOX [[https://papers.nips.cc/paper_files/paper/2019/hash/87784eca6b0dea1dff92478fb786b401-abstract.html][time matters in regularizing deep networks: weight decay and data augmentation affect early learning dynamics, matter little near convergence]]
...
* What shoul be learned first?

* Schema formation in a naural population subspace underlies learning-to-learn in flexibel sensorimoter problem-solving
a
 :properties:
...
* context-dependent conputation by recurrent dynamiocs in prenfrontal cortex
 :properties:
  :author: david mayo, mengye ren,gamaledin elsyaed...
  :year: 2023
  :journal: 
...
* Flexible multitask conputation in recurrent network shared dynamical motifs 
* transfer learning in deep leinforcement learning: a survey
...
* inferring neural activity beforie plasticity as a foundation for learning beyond backpropagation
 :properties:
...
- you are measureing model complexity wrong
  - これがLLC論文の前段に対応する
- LLC＋diff
* learning order if statistics and Distribution Simplicity Bias
- Transformer
  - [[https://arxiv.org/abs/2410.19637][[2410.19637] A distributional simplicity bias in the learning dynamics of transformers]]
- 
  - [[https://arxiv.org/abs/2402.04362][[2402.04362] Neural Networks Learn Statistics of Increasing Complexity]]
    - 
  - https://github.com/EleutherAI/features-across-time

* GPT
  keep getting those “easy” examples right, even as they later fit more complex patterns
  この部分，increasing と矛盾してない？

** 
** Internal Representation Structure Supporting DSB
** Methods for Observing and Quantifying Representation Change
** Theoretical Frameworks for Developmental Dynamics
** 
