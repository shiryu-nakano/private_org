...
- 草稿執筆
  ...
  - 手法をまとめる
  - 結果→まだ
- 2000コメダにて作業再開，23時まで作業できるかも
- ひとまず中西先生とのMTGは年始まで遅れた．今すぐやることは，今考えていることのゼミ発表
  - 

  
** 2025-12-11 14:06  :B4:
*** 論文メモ Neural Network Learns Statistics of Increasing Complexity

ネットワークの汎化性能はすごい

**** memo
- [ ] DSBとは
- [ ] 最大エントロピー分布とは何か，これは最適輸送で作ったデータセットと何が違う？
- [ ]  2,Theory and Methodsがよくわからん
- Fig3 3つの列は左から
** 2025-12-11 20:37  :B4:
*** 論文メモ
**** 何が新しい？

単純性バイアスの先に，DSBがあるのだということ
DSBは仮説
...
自分にとって
DSBのもう少しシンプルな定義とか，話が出てきた流れがわかるかも

深層モデルの不思議：
over parametarizeされていて，ランダムラベルに適合できるほどの表現力を持っているにも関わらず，
汎化性能が高い．

これは従来「単純性バイアス simplicity bias」で説明がされてきた．
例えば，


この論文で単純性バイアスをデータが持つ構造の視点から定量化することを目指した．

具体的に示したこと：
「SGD＋誤差逆伝播で画像分類タスクを学習したニューラルネットワークは，自然と，学習の始め平均や共分散のような低次の統計量を用いて入力を分類し，学習が進むにつれて高次の統計量を用いるようになっている」

これによってDSBをデータの持つ構造，つまりモーメント統計量の観点から捉え直した．

っλ

**** めも
simplicity biasはモデルの持つ傾向
SGDのimplicit biasという概念も存在する
...
1.intro
  conjecture 1
2.toymodel
3. Learning increasingly complex distributions
on CIFAR10
4. Discussion
